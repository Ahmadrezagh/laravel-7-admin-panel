...
<div id="wrapper">
    ...
    <div class="left-side-menu">
        ...
        <div class="slimScrollDiv active" style="position: relative; overflow: hidden; width: auto; height: 200px;">
            <div class="slimscroll-menu in" style="overflow: hidden; width: auto; height: 200px;">
                <div id="sidebar-menu" class="active">
                    ...
                    <ul class="metismenu in" id="side-menu">
                        ...
                        @if (auth('admin')->user()->can('canAdmin') or auth('admin')->user()->id == 1)
                            <li>
                                ...
                                <ul class="nav-second-level collapse" aria-expanded="false">
                                    <li>
                                        <a href="{{ route('role.create') }}"> تعریف نقش</a>
                                    </li>
                                    <li>
                                        <a href="{{ route('admin.index') }}">لیست ادمین ها</a>
                                    </li>
                                    <li>
                                        <a href="{{ route('admin.create') }}"> تعریف ادمین</a>
                                    </li>
                                </ul>
                            </li>
                        @endif

                        @if (auth('admin')->user()->can('canCategory') or auth('admin')->user()->id == 1)
                            <li>
                                <a href="javascript: void(0);">
                                ...
                                <ul class="nav-second-level collapse" aria-expanded="false">
                                    <li>
                                        <a href="{{ route('category.create') }}"> تعریف دسته بندی</a>
                                    </li>
                                    <li>
                        ...
                        @if (auth('admin')->user()->can('canSetting') or auth('admin')->user()->id == 1)
                            <li>
                                <a href="javascript: void(0);">
